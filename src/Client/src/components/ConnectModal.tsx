          ...
          <Modal.Dialog className="bg-zinc-900 border border-zinc-800 shadow-2xl rounded-xl overflow-hidden">
            ...
            <Modal.Body className="flex flex-col gap-5 p-6 bg-zinc-900">
              ...
              <TextField>
                ...
                <Input placeholder="192.168.1.x" className="bg-zinc-950 border-zinc-800 focus:border-emerald-500" />
              </TextField>

              <TextField>
                <Label className="text-zinc-300 font-medium mb-1">Port</Label>
                <Input placeholder="5000" defaultValue="5000" className="bg-zinc-950 border-zinc-800 focus:border-emerald-500" />
            ...
            <Modal.Footer className="border-t border-zinc-800 p-4 bg-zinc-900/50 flex justify-end gap-3">
              ...
              <Button className="bg-emerald-600 hover:bg-emerald-500 text-white font-medium shadow-[0_0_15px_rgba(5,150,105,0.3)]">Connect</Button>
            </Modal.Footer>
          </Modal.Dialog>
        </Modal.Container>
      </Modal.Backdrop>
